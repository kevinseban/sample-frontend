...
function EditStudent() {
    ...
    useEffect(() => {
        Axios.get("https://sample-student-backend.onrender.com/studentRoute/update-student/" + id)
            .then((res) => {
                if (res.status === 200) {
    ...
    const handleSubmit = () => {
        ...
        Axios.put("https://sample-student-backend.onrender.com/studentRoute/update-student/" + id, data)
            .then((res) => {
                if (res.status === 200)
